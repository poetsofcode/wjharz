...
class SppagebuilderAddonPerson extends SppagebuilderAddons{
	...
	public function render() {
		...
		$font_awesome_version = $config->get('fontawesome_version', '5');
		...
		if($facebook || $twitter || $youtube || $linkedin || $pinterest || $flickr || $dribbble || $behance || $instagram) {
			...
			if($font_awesome_version == '5'){
				...
				if($pinterest) 		$social_icons .= '<li><a target="_blank" rel="noopener noreferrer" href="' . $pinterest . '" aria-label="Pinterest"><i class="fab fa-pinterest-p" aria-hidden="true" title="Pinterest"></i></a></li>';
	...
	public static function getTemplate(){
		...
		$output ='
			...
			if(faIconList.version !== "undefined" && faIconList.version === 5) {
				...
				if (!_.isEmpty(data.pinterest)) {
					social_icon_list += `<li><a target="_blank" href="${data.pinterest}"><i class="fab fa-pinterest-p"></i></a></li>`;
				}
				...
				if (!_.isEmpty(data.facebook)) {
					social_icon_list += `<li><a target="_blank" href="${data.facebook}"><i class="fa fa-facebook"></i></a></li>`;
				}
				if (!_.isEmpty(data.twitter)) {
					social_icon_list += `<li><a target="_blank" href="${data.twitter}"><i class="fa fa-twitter"></i></a></li>`;
				}
				if (!_.isEmpty(data.youtube)) {
					social_icon_list += `<li><a target="_blank" href="${data.youtube}"><i class="fa fa-youtube"></i></a></li>`;
				}
				if (!_.isEmpty(data.linkedin)) {
					social_icon_list += `<li><a target="_blank" href="${data.linkedin}"><i class="fa fa-linkedin"></i></a></li>`;
				}
				if (!_.isEmpty(data.pinterest)) {
					social_icon_list += `<li><a target="_blank" href="${data.pinterest}"><i class="fa fa-pinterest"></i></a></li>`;
				}
				if (!_.isEmpty(data.flickr)) {
					social_icon_list += `<li><a target="_blank" href="${data.flickr}"><i class="fa fa-flickr"></i></a></li>`;
				}
				if (!_.isEmpty(data.dribbble)) {
					social_icon_list += `<li><a target="_blank" href="${data.dribbble}"><i class="fa fa-dribbble"></i></a></li>`;
				}
				if (!_.isEmpty(data.behance)) {
					social_icon_list += `<li><a target="_blank" href="${data.behance}"><i class="fa fa-behance"></i></a></li>`;
				}
				if (!_.isEmpty(data.instagram)) {
					social_icon_list += `<li><a target="_blank" href="${data.instagram}"><i class="fa fa-instagram"></i></a></li>`;
				}
			}
			#>
