...
akeeba.System.documentReady(function () {
	var hasHandler = (document.getElementById('removeaddhandler') && !document.getElementById('removeaddhandler').disabled);
	...
	// Hook disabling AddHandler if we use the default .htaccess file
	if (hasHandler)
	{
		akeeba.System.addEventListener('replacehtaccess', 'click', function(){
			document.getElementById('removeaddhandler').checked = !this.checked;
			document.getElementById('removeaddhandler').disabled = this.checked;

			document.getElementById('updateaddhandler').checked = false;
			document.getElementById('updateaddhandler').disabled = this.checked;
		})

		akeeba.System.addEventListener('removeaddhandler', 'click', function(){
			if (this.checked){
				document.getElementById('updateaddhandler').checked = false;
			}
		})

		akeeba.System.addEventListener('updateaddhandler', 'click', function(){
			if (this.checked){
				document.getElementById('removeaddhandler').checked = false;
			}
		})
	}
});
