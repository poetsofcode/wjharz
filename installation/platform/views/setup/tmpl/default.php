	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--orange">
			...
			<?php if ($this->htaccessSupported): ?>
                ...
                <div class="akeeba-form-group--checkbox--pull-right">
                    <label <?php echo $this->removeHandlerOptions['disabled'] ?>>
                        <input type="checkbox" value="1" id="removeaddhandler"
                               name="removeaddhandler" <?php echo $this->removeHandlerOptions['disabled'] ?> <?php echo $this->removeHandlerOptions['checked'] ?> />
						<?php echo AText::_('SETUP_LBL_SERVERCONFIG_REMOVEADDHANDLER') ?>
                    </label>
                    <span class="akeeba-help-text" style="display: none">
						  <?php echo AText::_($this->removeHandlerOptions['help']) ?>
					</span>
                </div>

                <div class="akeeba-form-group--checkbox--pull-right">
                    <label <?php echo $this->updateHandlerOptions['disabled'] ?>>
                        <input type="checkbox" value="1" id="updateaddhandler"
                               name="removeaddhandler" <?php echo $this->updateHandlerOptions['disabled'] ?> <?php echo $this->updateHandlerOptions['checked'] ?> />
						<?php echo AText::_('SETUP_LBL_SERVERCONFIG_UPDATEADDHANDLER') ?>
                    </label>
                    <span class="akeeba-help-text" style="display: none">
						  <?php echo $this->updateHandlerOptions['help'] ?>
					</span>
                </div>
			<?php endif; ?>
