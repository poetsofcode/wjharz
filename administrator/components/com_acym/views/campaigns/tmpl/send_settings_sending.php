...
<div class="cell grid-x margin-top-1">
	...
	<div class="cell grid-x margin-top-1 medium-4">
        <?php
        $label = acym_translation_sprintf('ACYM_TRACK_THIS_X', strtolower(acym_translation('ACYM_CAMPAIGN')));
        $label .= acym_info(acym_translation_sprintf('ACYM_TRACK_THIS_X_DESC', strtolower(acym_translation('ACYM_CAMPAIGN'))));
