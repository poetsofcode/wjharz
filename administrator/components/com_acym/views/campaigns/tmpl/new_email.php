...
?><form id="acym_form" action="<?php echo acym_completeLink(acym_getVar('cmd', 'ctrl')); ?>" method="post" name="acyForm">
	<div id="acym__email__new" class="cell grid-x grid-margin-y align-center acym__content margin-top-2">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<div class="acym__email__new__card cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['campaign_link']; ?>">
			...
			<div class="acym__email__new__card cell large-2 medium-4 text-center acym__email__new__card-list" acym-data-link="<?php echo $data['welcome_email_link'];; ?>">
			...
			<div class="acym__email__new__card cell large-2 medium-4 text-center acym__email__new__card-list" acym-data-link="<?php echo $data['unsubscribe_email_link'];; ?>">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<div class="acym__email__new__card <?php echo !acym_level(2) ? 'acym__email__new__card__disabled' : ''; ?> cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['campaign_auto_link'];; ?>">
				<i class="acymicon-cog acym__email__new__card__icon"></i>
				<h1 class="acym__email__new__card__title"><?php echo acym_translation('ACYM_AUTOMATIC_CAMPAIGN'); ?></h1>
				<p class="acym__email__new__card__description"><?php echo acym_translation('ACYM_AUTOMATIC_CAMPAIGN_DESC'); ?></p>
                <?php if (!acym_level(2)) echo '<div class="acym__email__new__card__disabled__container_test cell">'.acym_translation('ACYM_ONLY_AVAILABLE_ENTERPRISE_VERSION').'</div>'; ?>
			</div>
			<div class="acym__email__new__card <?php echo !acym_level(1) ? 'acym__email__new__card__disabled' : ''; ?> cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['campaign_scheduled_link'];; ?>">
