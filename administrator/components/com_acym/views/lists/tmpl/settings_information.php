...
<div class="cell grid-x grid-margin-x margin-left-0 margin-right-0">
	...
	<div class="cell grid-x small-6">
        <?php
        $label = acym_translation_sprintf('ACYM_TRACK_THIS_X', strtolower(acym_translation('ACYM_LIST')));
        $label .= acym_info(acym_translation_sprintf('ACYM_TRACK_THIS_X_DESC', strtolower(acym_translation('ACYM_LIST'))));
